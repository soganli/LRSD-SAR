function [x, error, iter, flag] = cg_phase(H,HH,x,B,y,M, betaks, parameters)
...
tol = parameters.cgtol*15;

bnrm2 = norm( y );
if  ( bnrm2 == 0.0 ), bnrm2 = 1.0; end

b = B.*HH(y) + lambda*betaks;
AX =  B.*(HH(H(B.*x))) + lambda.*x;
r = b-AX;
%r = b - H(x);
error = norm( r ) / bnrm2;
